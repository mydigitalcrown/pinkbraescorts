                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+919372662471" class="text-pink-500 font-semibold text-lg hover:text-pink-600">
                                    +91 9372662471
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="https://api.whatsapp.com/send?phone=919372662471" class="text-green-500 font-semibold text-lg hover:text-green-600">
                                    +91 9372662471
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@pinkbra.in" class="text-blue-500 font-semibold text-lg hover:text-blue-600">
                                    info@pinkbra.in
                                </a>
                            </div>
                        </div>
