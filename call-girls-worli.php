...
<main class="min-h-screen bg-gradient-to-br from-gray-50 to-pink-50">
    ...
    <section class="relative py-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="images/locations/mumbai/worli.webp" alt="Worli Mumbai Background" class="w-full h-full object-cover opacity-30">
        </div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                Sophisticated Escorts in Worli
                <span class="block text-2xl md:text-3xl font-normal mt-2 opacity-90">
                    Premium Companions Sea Link Area Mumbai
                </span>
            </h1>
            <p class="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed opacity-90">
                Sophisticated companions in Worli with sea-facing luxury experiences and premium service.
            </p>
